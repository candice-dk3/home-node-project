          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form @submit.prevent>
                          <div class="container">
                              <input class="form-control m-2" type="text" placeholder="Enter product ID" v-model="updateProduct.prodID" required readonly>
                              <input class="form-control m-2" type="text" placeholder="Enter product name" v-model="updateProduct.prodName" required>
                          ...
                          <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-outline-success" @click="updateProductFx()">Save Changes</button>
                          </div>
                      </form>
                  </div>
              </div>
...
export default {
  ...
  methods:{
      updateProductFx() {
          this.$store.dispatch('updateProduct', this.updateProduct);
      },
  }
}
</script>
